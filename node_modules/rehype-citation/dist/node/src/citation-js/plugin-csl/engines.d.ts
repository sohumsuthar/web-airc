 ...
 */
declare function prepareEngine(data: Array<any>, style: any, locale: any, format: string): any;
/**
 ...
 * @return {Object} CSL Engine
 */
export function fetchEngine(style: string, locale: any, styleXml: any, retrieveItem: any, retrieveLocale: any): any;
