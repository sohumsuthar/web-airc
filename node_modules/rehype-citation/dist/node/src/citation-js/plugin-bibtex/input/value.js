...
export const valueGrammar = new util.Grammar({
    ...
    BracketString() {
        ...
        (_a = this.state).partlyLowercase && (_a.partlyLowercase = this.state.sentenceCase);
    ...
    Text() {
        ...
        if (!this.state.sentenceCase) {
            (_a = this.state).partlyLowercase || (_a.partlyLowercase = text === text.toLowerCase() && text !== text.toUpperCase());
            return text;
        }
