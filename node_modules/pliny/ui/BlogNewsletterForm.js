...
var BlogNewsletterForm = ({ title, apiUrl }) => /* @__PURE__ */ jsx("div", { className: "flex items-center justify-center", children: /* @__PURE__ */ jsx("div", { className: "bg-gray-100 p-6 dark:bg-gray-800 sm:px-14 sm:py-8", children: /* @__PURE__ */ jsx(NewsletterForm_default, { title, apiUrl }) }) });
var BlogNewsletterForm_default = BlogNewsletterForm;

export { BlogNewsletterForm_default as default };
